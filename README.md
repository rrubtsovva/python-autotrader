pumpy Bot is a tool for managing trading strategies, liquidity and monitoring tokens on the Solana blockchain, and help to autotrade.

This bot is designed for token creators, liquidity pools and traders, providing a user-friendly interface for automating trading operations via console.

(The bot is available only for mac and windows)
...
Enter a unique username for the bot ending in bot (e.g. pumpy_PumpBot).
...
In Telegram, search for your bot by username (e.g. @pumpy_PumpBot).
